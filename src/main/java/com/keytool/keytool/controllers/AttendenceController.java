...
public class AttendenceController {
    ...
    public ResponseEntity<List<Attendence>> getAttendanceByEmployee(@PathVariable Long userId) {
        List<Attendence> attendanceList = attendenceService.getAttendenceforEmployee(userId);
